...
public class ApiController {
	...
	public String restApiGetWeather(Model model) throws Exception {
		...
		String url = "https://apis.data.go.kr/B551014/SRVC_OD_API_SFMS_FACI/TODZ_API_SFMS_FACI_I_NEW"
				+ "?serviceKey=k6EXpf24BTsv3wtGfRyg5NZRY1vMEdz7lHwFPU7Wlg9%2BxxsMIRFvRLf46bdVGghYBUs4u6Xi08jqbOlPXOKZqw%3D%3D"
				+ "&resultType=JSON" // JSON, XML
				+ "&pageNo=1" // 페이지 번호
